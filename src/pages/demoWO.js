export default {
  app: [
    ...
    { type: 'custom', parentId: 'canvas_tabgroup1_tab1', id: 'canvas_custom1', detail: { fileName:'appQuery'} },
    { type: 'table', parentId: 'canvas_tabgroup1_tab1', id: 'canvas_tabgroup1_tab1_table1',
      detail: { label: '',isMain: true,width:1400,bordered:true,whereClause:"this.woNum = '9527'",orderBy:"woNum DESC,desc" }},
    { type: 'tablecol', parentId: 'canvas_tabgroup1_tab1_table1', id: 'canvas_tabgroup1_tab1_table1_col1',
      detail: { label: '工单编号',dataAttribute:'woNum',event:'selectRecord',width: 400,sortable: true}},
    ...
    { type: 'combobox', parentId: 'canvas_tabgroup1_tab2_row1_col2', id: 'canvas_tabgroup1_tab2_row1_col2_text1_2',
      detail: {label:'状态',dataAttribute: 'status',keyAttribute: 'value', displayAttribute: 'description', listAttribute: 'statusSelect',inputMode:'readonly'}},
    ...
    { type: 'table', parentId: 'canvas_tabgroup1_tab2_section1_col1', id: 'canvas_tabgroup1_tab2_section1_table1',
      detail: { objName: 'assocEQ',pageSize: 5, expandable: true, expandedFirstRow: false, width: 1000,whereClause:"this.eqNum = '9527'",orderBy:"eqNum"}},
    ...
    { type: 'tablecol', parentId: 'canvas_tabgroup1_tab2_section1_table1', id: 'canvas_tabgroup1_tab2_table1_col4',
      detail: { label: '主装备',dataAttribute:'isMain'}},
    { type: 'checkbox', parentId: 'canvas_tabgroup1_tab2_table1_col4', id: 'canvas_tabgroup1_tab2_table1_col4_cb1', detail: { label: '', hideLabel: true}},
    { type: 'tablecol', parentId: 'canvas_tabgroup1_tab2_section1_table1', id: 'canvas_tabgroup1_tab2_table1_col5',
      detail: { label: '装备编号1',dataAttribute:'eqNum'}},
    { type: 'combobox', parentId: 'canvas_tabgroup1_tab2_table1_col5', id: 'canvas_tabgroup1_tab2_table1_col5_cb1',
      detail: {label:'',hideLabel:true, keyAttribute: 'eqNum', displayAttribute: 'desc', listAttribute: 'eqNumSelect',}},
  ...
  buttons: [
    { type: 'appbutton', id: 'wo_addBtn', detail: { label: '新增',event:'insert',icon:'plus',visible: ['list','insert'] }},
    { type: 'appbutton', id: 'wo_prevBtn', detail: { label: '上一条',event:'previous',icon:'left',visible:'insert' }},
    { type: 'appbutton', id: 'wo_nextBtn', detail: { label: '下一条',event:'next',icon:'right',visible:'insert' }},
    { type: 'appbutton', id: 'wo_saveBtn', detail: { label: '保存',event:'save',icon:'save',visible:'insert' }},
    { type: 'appbutton', id: 'wo_routeWFBtn', detail: { label: '发送工作流',event:'routeWF',icon:'partition',visible:'insert' }},
    { type: 'appbutton', id: 'wo_changeStatus', detail: { label: '变更状态',event:'dialogOpen', eventValue:'status', icon:'securityScan',visible:'insert' }},
  ],
  actions: [
    {type:'appaction', id: 'wo_action1', detail: {event: 'viewWF', label: '查看流程图'}},
    {type:'appaction', id: 'wo_action2', detail: {event: 'action2', label: '操作二'}},
    {type:'appaction', id: 'wo_action3', detail: {event: 'action3', label: '操作三'}},
  ]
};
